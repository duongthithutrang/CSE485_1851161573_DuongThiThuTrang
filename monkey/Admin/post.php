            ...
            <div id="ja-container">
                <div id="ja-container2" class="clearfix">
                    ...
                    <div id="ja-mainbody" class="clearfix">
                        ...
                        <div class="title-module">DANH SÁCH BÀI VIẾT</div>
                        ...
                        <div class="container">
                            <table class="list-course table" >
                                ...
                                ?>
                                    <tr>
                                        <td class="text-center"><a href="posts_edit.php?id=<?php echo $row['0']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                        <td class="text-center"><a href="posts_delete.php?id=<?php echo $row['0']; ?>"><i class="fa fa-trash"></i></a></td>
                                        <td><?php echo $row['0']; ?></td>
                                        <td><?php echo $row['1']; ?></td>
                                        <td><?php echo $row['2']; ?></td>
                                        <td class="text-center"><?php echo '<img width="70px" height="70px" src="'.$row['4'].'" />'; ?></td>
                            ...
                            <div class="task">
                                <a href="posts_update.php"><input type="button" value="Thêm mới" name="Thêm mới"></a>
